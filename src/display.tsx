...
export interface BacklinksDisplayProps {}

export interface BacklinksDisplayState {
    id: string;
    backlinks: Array<Backlink>;
}

export default class BacklinksDisplay extends React.Component<BacklinksDisplayProps, BacklinksDisplayState> {
    state: Readonly<BacklinksDisplayState> = { id: '', backlinks: [] };
    ...
    render = () => {
        return (
            <>
                <div className="editor-drawer-separator"></div>
                <div className="editor-drawer-section-header">Backlinks</div>
    ...
    backlinkitem = (backlink: Backlink) => {
        return (
            <div className="editor-drawer-item  clickable">
                <div className="icon-container">
                    <svg
                        ...
                        <path
                            ...
                            className="hyperlink-2_svg__a"></path>
                    </svg>
                </div>
                <div
                    className="caption"
